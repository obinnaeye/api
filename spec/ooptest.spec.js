...
describe("Author's Name", function(){
	...
	it('Should be a function: create', function(){
	...
	it('Should be a function: deletenote', function(){
		expect(typeof(NotesApplication.prototype.deletenote)).toBe(typeof(function(){}));
	})

	it('Should accept only integer: get', function(){
		expect(NotesApplication.prototype.get("obi")).toBe("That type is invalid. index hs to be an integer value, try again.");
	})
